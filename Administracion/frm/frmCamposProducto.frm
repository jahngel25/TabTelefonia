   ...
   Begin VB.Frame fraFondoEdicion 
      ...
      Begin Threed.SSPanel pnlCampo 
         ...
         Begin VB.CheckBox chkValidarRepetidos 
            ...
            Width           =   1545
         End
         Begin VB.CheckBox chkEditableOT 
            Caption         =   "OT"
            Height          =   195
            Left            =   1020
            TabIndex        =   40
            ...
            Width           =   1035
         End
         Begin VB.CheckBox chkEditableAtencion 
            Caption         =   "Atención"
            Height          =   195
            Left            =   1020
            TabIndex        =   39
         ...
         Begin VB.ComboBox cboCampos 
            ...
            Left            =   990
            List            =   "frmCamposProducto.frx":0CD5
            Style           =   2  'Dropdown List
            TabIndex        =   7
            Top             =   360
            Width           =   4320
         ...
         Begin VB.TextBox txtTamano 
            ...
            Width           =   705
         End
         Begin VB.CheckBox chkEditableVenta 
            Caption         =   "Venta"
            Height          =   195
            Left            =   1020
            TabIndex        =   12
...
Public Sub BuscarCampo()
    Dim i As Integer
    On Error GoTo ErrManager

    For i = 0 To Me.cboCampos.ListCount - 1
        If cboCampos.List(i) = proCampo Then
            cboCampos.ListIndex = i
            Exit For
        End If
    Next
...
ErrManager:
    SubGMuestraError
End Sub
Public Sub PriductListIndex(ListIndex As Long)
    On Error GoTo ErrManager
    
    Me.cboCodigoProducto.ListIndex = ListIndex
    Me.cboNombreProducto.ListIndex = ListIndex
    Call cmdNuevo_Click
...
Private Sub cmdGuardar_Click()
    ...
    If FunFValidarInformacion Then
        ...
        varParametrosxProducto.proEditableVenta = Me.chkEditableVenta.Value
        varParametrosxProducto.proEditableAtencion = Me.chkEditableAtencion.Value
        varParametrosxProducto.proEditableOT = Me.chkEditableOT.Value
        
        varParametrosxProducto.proValidarRepetidos = Val(Me.chkValidarRepetidos.Value)
        varParametrosxProducto.proCampoPadre = IIf(proCampoPadre = "0", "", proCampoPadre)
        varParametrosxProducto.ProOrden = Me.ProOrden
...
Private Sub SubFInicializarGrid()
    ...
    With Me.grdCampos
        ...
        .ColWidth(11) = 1605
        .CellAlignment = 4
        .TextMatrix(0, 11) = "Editable Venta"
        
        .Col = 12
        .ColWidth(12) = 1605
        .CellAlignment = 4
        .TextMatrix(0, 12) = "Editable Atencion"
        
        .Col = 13
        .ColWidth(13) = 1605
        .CellAlignment = 4
        .TextMatrix(0, 13) = "Editable OT"
        
        .Col = 14
        .ColWidth(14) = 1605
        .CellAlignment = 4
        .TextMatrix(0, 14) = "Validar Repetidos"
        .Row = 0
        .Col = 0
    End With
...
Public Sub SubFPintarGrid()
    ...
    Dim varEditableVenta As String
    Dim varEditableAtencion As String
    Dim varEditableOT As String
    ...
    For varContador = 1 To Me.proParametrosProducto.Count
        ...
        If Me.proParametrosProducto.Item(varContador).proEditableVenta = True Then
            varEditableVenta = "Si"
        Else
            varEditableVenta = "No"
        End If
        
        If Me.proParametrosProducto.Item(varContador).proEditableAtencion = True Then
            varEditableAtencion = "Si"
        Else
            varEditableAtencion = "No"
        End If
        
        If Me.proParametrosProducto.Item(varContador).proEditableOT = True Then
            varEditableOT = "Si"
        Else
            varEditableOT = "No"
        End If
        ...
        Me.grdCampos.AddItem Me.proParametrosProducto.Item(varContador).proProductNumber & vbTab & _
                             ...
                             varEditableVenta & vbTab & _
                             varEditableAtencion & vbTab & _
                             varEditableOT & vbTab & _
                             varValidarRepetidos
    ...
    Me.chkObligatorioAtencion.Value = 0
    Me.chkObligatorioOT.Value = 0
    Me.chkEditableVenta.Value = 0
    Me.chkEditableAtencion.Value = 0
    Me.chkEditableOT.Value = 0
    Me.chkInterfase.Value = 0
    Me.chkValidarRepetidos.Value = 0
    Me.txtPosicion.Text = ""
...
Public Sub grdCampos_Click()
    ...
    Else
        ...
        If Me.proParametrosProducto.Item(Me.grdCampos.Row).proEditableVenta = True Then
            Me.chkEditableVenta.Value = 1
        Else
            Me.chkEditableVenta.Value = 0
        End If
        
        If Me.proParametrosProducto.Item(Me.grdCampos.Row).proEditableAtencion = True Then
            Me.chkEditableAtencion.Value = 1
        Else
            Me.chkEditableAtencion.Value = 0
        End If
        
        If Me.proParametrosProducto.Item(Me.grdCampos.Row).proEditableOT = True Then
            Me.chkEditableOT.Value = 1
        Else
            Me.chkEditableOT.Value = 0
        End If
